class Shape {
  ...
  renderText() {
    return `<text x="125" y="150" font-size="50" font-family="arial" text-anchor="middle" fill="${this.textColor}">${this.text}</text>`;
  }
}
...
class Triangle extends Shape {
  ...
  render() {
    return `<polygon points="50,50 100,100 150,50" fill=${this.shapeColor}"/>`;
  }
}
